...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray*prhs[]) {
    ...
    if (mean_cycle_algo_id == 0)
        mean_cycle_algo = "karp";
    else if (mean_cycle_algo_id == 1)
        mean_cycle_algo = "howard";
    else if (mean_cycle_algo_id == 3)
        mean_cycle_algo = "custombnb";
    else if (mean_cycle_algo_id == 4)
        mean_cycle_algo = "custombnbcuda";
    else if (mean_cycle_algo_id == 5)
    ...
    if (mean_cycle_algo_id > 6) {
        ...
        out = pgen.solveWithMeanCycle(mean_cycle_algo);
    }
